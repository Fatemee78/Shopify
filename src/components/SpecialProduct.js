    ...
    <div className='col-4 mb-3'>
        <div className="special-prod-card">
            <div className="d-flex justify-content-between">
                <div>
                    <img src="images/fueatured/applewatch.jpg" alt="Product-img" className='img-fluid' />

                </div>
                <div className="special-prod-content">
                    <h5>Smart Watch</h5>
                    <h6 className='title'>Smart Watch Version 14</h6>
                    <ReactStars
                        count={5} 
                        size={24} 
                        value='3' 
